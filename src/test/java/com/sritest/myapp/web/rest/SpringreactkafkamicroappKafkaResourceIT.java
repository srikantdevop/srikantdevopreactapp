...
class SpringreactkafkamicroappKafkaResourceIT {
    ...
    void setup() {
        ...
        SpringreactkafkamicroappKafkaResource kafkaResource = new SpringreactkafkamicroappKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/springreactkafkamicroapp-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/springreactkafkamicroapp-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
