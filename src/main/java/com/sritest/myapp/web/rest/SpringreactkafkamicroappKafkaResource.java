...
@RestController
@RequestMapping("/api/springreactkafkamicroapp-kafka")
public class SpringreactkafkamicroappKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SpringreactkafkamicroappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SpringreactkafkamicroappKafkaResource(KafkaProperties kafkaProperties) {
